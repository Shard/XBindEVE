;;;; xbindeve.scm --- Handling keybinds for EVE Online
...
;; @TODO should construct a list the length of "eve-accounts"
(define eve-active (list #nil #nil #nil #nil #nil #nil))
...
;; Utility
(define eve-get-character-pos (lambda (name)
...
(define eve-open-account (lambda (character)
                           (run-command (string-append "wmctrl -R '" (string-append character "'")))))
